...
#thus it can be concluded by multiple r squared value that the model is good as p value of slope test is <0.05
...
#Answer c)
#test and training accuracy, dataset comment1
